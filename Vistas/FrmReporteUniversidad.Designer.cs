namespace Vistas
{
	partial class FrmReporteUniversidad
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "FrmReporteUniversidad";
			this.Text = "FrmReporteUniversidad";
			this.Load += new System.EventHandler(this.FrmReporteUniversidad_Load);
